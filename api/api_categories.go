...
func (r ApiGetChildrenRequest) CategoryId(categoryId string) ApiGetChildrenRequest {
...
func (r ApiGetChildrenRequest) Execute() (InlineResponse200, *_nethttp.Response, error) {
...
*/
func (a *CategoriesApiService) GetChildren(ctx _context.Context) ApiGetChildrenRequest {
	return ApiGetChildrenRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CategoriesApiService) GetChildrenExecute(r ApiGetChildrenRequest) (InlineResponse200, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CategoriesApiService.GetChildren")
	if err != nil {
